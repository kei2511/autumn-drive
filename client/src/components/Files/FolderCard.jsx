...
const FolderCard = ({ name, onClick, onDelete, isDeleting }) => {
  return (
    <div
      ...
      className={`group flex flex-col p-4 rounded-xl bg-ctp-base border border-ctp-surface0/20 hover:border-ctp-blue/50 hover:bg-ctp-mantle hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer relative overflow-hidden ${isDeleting ? "opacity-70 pointer-events-none" : ""}`}
    >
